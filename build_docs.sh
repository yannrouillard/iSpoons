...
mkdir -p .docs_tmp
python3 "${HAMMERSPOON_PATH}/scripts/docs/bin/build_docs.py" -e "${HAMMERSPOON_PATH}/scripts/docs/templates/" -o .docs_tmp -i "Hammerspoon Spoons" -u "https://github.com/yannrouillard/Spoons/blob/master/" -j -t -n Source
